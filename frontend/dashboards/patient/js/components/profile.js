(function(window){
  ...
  async function loadProfile(){
    ...
    try{
      ...
      changeForm.innerHTML = `\n+        <h3 style="margin-top:1rem;">Cambiar contraseña</h3>\n+        <form id="change-password-form" autocomplete="off">\n+          <div style="margin-bottom:0.5rem;"><label>Contraseña actual</label><input type="password" name="old_password" autocomplete="current-password" required style="width:100%; padding:0.4rem; border:1px solid #ccc; border-radius:4px;"></div>\n+          <div style="margin-bottom:0.5rem;"><label>Nueva contraseña</label><input type="password" name="new_password" autocomplete="new-password" required minlength="6" style="width:100%; padding:0.4rem; border:1px solid #ccc; border-radius:4px;"></div>\n+          <div><button class="btn-primary" type="submit">Cambiar contraseña</button></div>\n+        </form>\n+      `;
